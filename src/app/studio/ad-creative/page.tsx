...
export default function AdCreativeStudio() {
  const [product, setProduct] = useState('Kynoviq Studio AI Creative Operating System');
  ...
  const [ads, setAds] = useState<any[]>([
    {
      ...
      headline: 'One Idea. Infinite Creation. Try Kynoviq Studio Free.',
      ...
      videoStoryboard: [
        ...
        { scene: 2, visual: 'Clean Kynoviq Studio dashboard generating full campaign in 30s', audio: 'Kynoviq brings your entire creative stack under one roof.' },
