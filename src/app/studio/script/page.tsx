...
export default function ScriptGeneratorStudio() {
  ...
  const [scriptData, setScriptData] = useState<any>({
    ...
    sceneBreakdown: [
      ...
      { sceneNumber: 3, visualDescription: '3D holographic workspace generating assets automatically', bRollSuggestions: ['AI neural nodes connecting', 'High-res video rendering on timeline'], voiceoverText: 'With Kynoviq Studio, you turn any idea into production-grade assets in 60 seconds.', durationEstimateSec: 10 },
      { sceneNumber: 4, visualDescription: 'Hero brand card with particle glow and CTA button', bRollSuggestions: ['Satisfied creator celebrating', 'Mobile feed getting thousands of likes'], voiceoverText: 'Try it today on Kynoviq Studio and create without limits!', durationEstimateSec: 8 },
    ],
    callToAction: 'Claim your 50 free credits on Kynoviq Studio today!',
