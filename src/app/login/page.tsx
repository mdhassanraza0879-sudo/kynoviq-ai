    ...
    <div className="glass-panel p-8 rounded-2xl border border-slate-800 space-y-6 shadow-2xl bg-slate-900/90">
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-slate-700 bg-slate-950 hover:bg-slate-800 text-xs font-bold text-white transition-all shadow-sm cursor-pointer"
        >
